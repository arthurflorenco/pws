...
export const NavDesk = () => {
  return (
    <nav className='xl:flex fixed justify-between items-center mt-2 max-w-[600px] w-[90%] px-6 py-2 bg-neutral-800 bg-opacity-70 backdrop-blur-md z-50 top-3 text-yellow-300 rounded-full hidden'>
