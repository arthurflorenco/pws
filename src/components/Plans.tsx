...
export const Plans = () => {
    ...
    return (
        <div className='min-h-screen w-full flex flex-col justify-center items-end xl:items-center p-5'>
            <span className='text-yellow-100 text-xl font-semibold border-[1px] border-yellow-100 p-3 rounded-xl mb-3'>Unsere Pläne</span>
            <h1 className='text-end xl:text-center text-yellow-300 text-5xl md:text-7xl font-bold'>1 Monat Gratis Für Neus</h1>
            <p className='text-white text-xl text-end xl:text-center mt-4'>Wenn du von einem Mitglied weiterempfohlen wirst und dich anmeldest, bekommst du den ersten Monat gratis. So kannst du den Club in Ruhe ausprobieren und leicht ins Training starten!</p>
