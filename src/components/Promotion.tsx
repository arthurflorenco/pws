    ...
    return (
        <div className='flex flex-col xl:flex-row w-full'>
            <div className='flex flex-col justify-center items-start px-4 w-full xl:w-[50%]'>
                <span className='text-yellow-100 text-md xl:text-xl font-semibold border-[1px] border-yellow-100 p-3 rounded-xl mb-3'>Nur für kurze Zeit</span>
                <h1 className='text-yellow-300 text-5xl md:text-7xl font-bold'>Probetraining <br /> gefällig?</h1>
                <p className='text-white text-md xl:text-xl mt-4'>
